...
- [CompaniesRestApi ^1.4.0](https://github.com/spryker/companies-rest-api) (Legacy Glue)
- [CompanyBusinessUnitAddressesRestApi ^1.3.0](https://github.com/spryker/company-business-unit-addresses-rest-api) (Legacy Glue)
- [CompanyBusinessUnitSalesConnector ^1.3.0](https://github.com/spryker/company-business-unit-sales-connector) (Connector)
- [CompanyBusinessUnitsRestApi ^1.5.0](https://github.com/spryker/company-business-units-rest-api) (Legacy Glue)
...
- [CompanyRolesRestApi ^1.2.0](https://github.com/spryker/company-roles-rest-api) (Legacy Glue)
- [CompanySalesConnector ^1.3.0](https://github.com/spryker/company-sales-connector) (Connector)
- [CompanyUserAuthRestApi ^2.2.0](https://github.com/spryker/company-user-auth-rest-api) (Legacy Glue)
...
- [CompanyUsersRestApi ^2.8.0](https://github.com/spryker/company-users-rest-api) (Legacy Glue)
